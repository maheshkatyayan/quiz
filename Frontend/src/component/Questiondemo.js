...
const QuestionDemo = () => {
  ...
  const handleFinalQuestion = async () => {
    ...
    try {
      const response = await axios.post("https://quiz-t7o5.onrender.com/quizsetup/addquestion_to_quiz", { data });
  ...
  const handleUpload = async (e) => {
    ...
    try {
      const response = await axios.post("https://quiz-t7o5.onrender.com/quiz/uploadMediaQuestion", formData, {
