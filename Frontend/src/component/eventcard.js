...
const EventCard = () => {
  return (
    <div className="flex justify-center items-center min-h-screen bg-gray-100">
      <div className="rounded-xl shadow-lg overflow-hidden group relative" 
           style={{ minWidth: '810px', maxWidth: '1199px', height: '380px' }}>
        <div className="absolute inset-0 bg-cover bg-center"
             style={{
               backgroundImage: "url('https://assets.vogue.in/photos/646c6fe48f85812e8d889001/2:3/w_2560%2Cc_limit/SUNNY2.jpg')"
             }}>
        </div>
