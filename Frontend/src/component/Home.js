...
import logo from '../imageeee/Club_logo.JPG.png';
    ...
    <div className="bg-gradient-to-r from-[#2e1a47] to-[#624a82] text-white min-h-screen flex flex-col justify-between relative">
      ...
      <div className="absolute inset-0 flex items-center justify-center -z-10">
        <div className="w-full h-full relative">
          <img src="https://tse3.mm.bing.net/th?id=OIP.QrXqKG_hGsR9qOSODO8m2QHaGw&pid=Api&P=0&h=180" className="absolute top-1/4 left-1/4 w-64 h-64 opacity-50" alt="Decorative 1" />
          {/* <img src="https://tse1.mm.bing.net/th?id=OIP.JgZTixgY5htCWowt6_mr1QHaFj&pid=Api&P=0&h=180" className="absolute bottom-1/3 right-1/3 w-48 h-48 opacity-50" alt="Decorative 2" />
          <img src="https://tse1.mm.bing.net/th?id=OIP.9FTbTOvgjccAz3rOCepNxwHaGM&pid=Api&P=0&h=180" className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-96 h-96 opacity-50 rounded-full" alt="Decorative 3" />
          <img src="https://tse2.mm.bing.net/th?id=OIP.FkiVjtnWyR3oTTgs6ZKOQgHaDt&pid=Api&P=0&h=180" className="absolute bottom-1/4 right-1/4 w-32 h-32 opacity-50 rounded-full" alt="Decorative 4" />
          <img src="https://tse1.mm.bing.net/th?id=OIP.g_uHI2whr5Mp-UELG2hUfAHaEo&pid=Api&P=0&h=180" className="absolute bottom-1/2 left-1/3 w-40 h-40 opacity-50 rounded-full" alt="Decorative 5" /> */}
        </div>
      </div>
    </div>
  );
